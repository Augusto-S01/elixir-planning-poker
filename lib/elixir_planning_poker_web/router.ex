defmodule ElixirPlanningPokerWeb.Router do
  ...
  # scope "/api", ElixirPlanningPokerWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:elixir_planning_poker, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: ElixirPlanningPokerWeb.Telemetry
