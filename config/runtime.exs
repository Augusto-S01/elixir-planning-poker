...
#
#     PHX_SERVER=true bin/elixir_planning_poker start
#
...
if config_env() == :prod do
  ...
  config :elixir_planning_poker, ElixirPlanningPoker.Repo,
    # ssl: true,
    url: database_url,
  ...
  #
  #     config :elixir_planning_poker, ElixirPlanningPoker.Mailer,
